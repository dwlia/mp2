...
class DosenController extends Controller
{
    ...
    public function historiPerwalian()
    {
        ...
        // Ambil histori perwalian beserta catatannya, diurutkan berdasarkan tanggal perwalian terbaru
        $historiPerwalian = Perwalian::where('dosen_id', $dosenId)
            ->with(['mahasiswa', 'catatanPerwalian'])
            ->orderBy('tanggal_perwalian', 'desc') // Urutkan berdasarkan tanggal perwalian terbaru
            ->get();
